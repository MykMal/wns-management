...
% As originally written, darkb2r creates a color map in which red corresponds to positive values
% and blue corresponds to negative values. We reversed this behavior, so that now red
% denotes negative values and blue denotes positive values. I also removed a few unnecessary
% semicolons, but everything else remains unchanged.

% Instructions: DO NOT RUN THIS FILE -- this file is used by ControlsPercentChangeSummary.m

% Dependencies: none

% version 07/31/2019
% modified version Copyright (c) 2019 Mykhaylo M. Malakhov
...
% cunjie zhang's original colors:
% red_top     = [0.5 0 0];
% red_middle  = [1 0 0];
% white_middle= [1 1 1];
% blue_middle = [0 0 1];
...
%  the light blue valued at -3 corresponds to light red valued at 3
